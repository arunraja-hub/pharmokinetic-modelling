...
class Model:
    ...
    This class acts as a medium to accept the user
    inputs for the pharmokinetic model

    Parameters
    ----------

    absorb: numeric, binary value where 1 means there is an
    absoption compartment and 0 vice versa
    ...
    def __init__(self, absorb, comp, V_c, CL, Q_p1=0, V_p1=0.1,
                 Q_p2=0, V_p2=0.1, k_a=0):
        self.absorb = absorb
        self.comp = comp
